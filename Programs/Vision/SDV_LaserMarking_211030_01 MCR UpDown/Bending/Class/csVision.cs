...
namespace Bending
{
    ...
    public class csVision
    {
        ...
        {
            bool result = false;
            bool bSubMark = false; //2차마크는 내부에서만 사용하는 
        ...
        public double scfInspResolutionX { get; set; }
        public double scfInspResolutionY { get; set; }
        public double scfInspectionXSpec { get; set; }
        public double scfInspectionYSpec { get; set; }
        public double scfInspectionTor { get; set; }
